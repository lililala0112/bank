...
!function (t, e) {
  ...
  function Z(t, e) {
    ...
    if (u.length || u.push(X(t, 1), X(t, 2), X(t, 3)), n = l ? b : f, l) a = h ? {
      ...
      return e;
    }(r) : r.getItem(0).matrix).a * a.x + r.c * a.y, r.b * a.x + r.d * a.y) : (r = R, o = a.x, a.y), e && "g" === t.tagName.toLowerCase() && (o = i = 0), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + i) + ")"), (h ? l : g).appendChild(n);else {
      ...
      if ("absolute" !== (s = m.getComputedStyle(t)).position) for (r = t.offsetParent; g !== r;) {
  ...
  function la(t, e, n, r, a, o, i, s, l) {
    return e = "cubic" === i.type ? [e] : (e.unshift(ja(n, r, s), a ? ja(n, a, l) : 0), i.relative && ka(e), [(a ? pointsToSegment : flatPointsToSegment)(e, i.curviness)]), e = o(nt(e, n, i)), rt(t, n, r, e, "x", s), a && rt(t, n, a, e, "y", l), cacheRawPathMeasurements(e, i.resolution || (0 === i.curviness ? 20 : 12));
  }
...
//# sourceMappingURL=motionpath.dev.js.map
